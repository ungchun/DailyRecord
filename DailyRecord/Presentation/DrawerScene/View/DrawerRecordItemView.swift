//
//  DrawerRecordItemView.swift
//  DailyRecord
//
//  Created by Kim SungHun on 12/1/24.
//
...
protocol DrawerRecordItemViewDelegate: AnyObject {
  func didTapRecord(_ record: RecordEntity)
}

final class DrawerRecordItemView: BaseView {
  
  // MARK: - Properties
  
  private let record: RecordEntity
  
  weak var delegate: DrawerRecordItemViewDelegate?
...
private extension DrawerRecordItemView {
